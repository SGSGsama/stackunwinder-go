...
// A reasonable size to cover all syscalls. Adjust if necessary.
#define AARCH64_SYSCALL_TABLE_SIZE 512

const unsigned char aarch64_syscall_args_count[AARCH64_SYSCALL_TABLE_SIZE] = {
    // Index: Syscall Number, Value: Argument Count
    [0] = 2,   // io_setup
    [1] = 1,   // io_destroy
    [2] = 3,   // io_submit
    [3] = 3,   // io_cancel
